...
def evaluate_system_quadratic_score(
    ...
    This mirrors the wiring in `evaluate_system_logsl`, but instead of
    computing a synthetic log likelihood, it returns:

        score = -sum((s_obs - mu_hat)**2)

    using a single simulation with 1000 patients.
    """
